# WeatherApp-Java
Weather Application Created using Java and Weather API to fetch the Current Weather, Forecast Weather and Unit Conversion.
## Screenshots
1.	Start of an Application:
 <img width="642" height="528" alt="image" src="https://github.com/user-attachments/assets/558b6e01-6e54-4dcc-b11c-76f1ce5cb70f" />
...
# Issues 
1.	Finding the Weather API as most of the API services are paid or either available for minimum amount of days. 
2.	Weather API data is available in JSON and using that in Java need some research
3.	Finding an API as per our requirement. 
 
